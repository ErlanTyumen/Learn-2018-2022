...
namespace Курсовая_работа_4_семестр
{
    public partial class Form1 : Form
    {
        ...
        private void tabPage1_Click(object sender, EventArgs e)
        {
            ...
            object file = @"C:\Users\Grost\Downloads\Arkhiv_WinRAR\Курсовая работа 4 семестр\Курсовая работа 4 семестр\bin\Debug\shablon.doc";
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 1; i < r.Paragraphs.Count; ++i)
                {
                    question = r.Paragraphs[i].Range.Text.Replace('\v', '\n');
        ...
        public void Method()
        {
            ...
            for (int i = 1; i <= numericUpDown3.Value; i++)
            {
                ...
                {
                    int num = bp.list[j].text.Split('\n').Length;
                    t.Range.Paragraphs[21 + j * num].Range.Text = $"{j + 1}. " + bp.list[j].text;
                    t.Range.Paragraphs[21 + j * num].Alignment = Word.WdParagraphAlignment.wdAlignParagraphLeft;
                    t.Range.Paragraphs[21 + j * num].CharacterUnitLeftIndent = 2f;
                    t.Range.InsertParagraphAfter();
                }
                t.Range.InsertAfter($"{bp.COM()}");
                doc.SaveAs($@"C:\Users\Grost\Downloads\Arkhiv_WinRAR\Курсовая работа 4 семестр\all\Билет-{i}.docx");
                doc.Close();
                app.Quit();
                app = null;
                doc = null;
